class AddPlIntoProducts < ActiveRecord::Migration
  def up
    #execute %q{
...
#              eid,
#              type,
#              cast(NEW.easel_name as varchar),
#              material_id,
#              product_type_id,
#              quality_id,
#              thickness_id,
...
#    }
  ...
  def down
#    execute %q{
#      DROP TRIGGER IF EXISTS update_easel_trigger ON products;
#      DROP FUNCTION IF EXISTS update_easel();
#    }
  end
end
